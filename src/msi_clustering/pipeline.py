...
from .visualization import MSIVisualizer
from .clustering import MSIClusterer
from .config import (
    total_components,
...
def main():
    ...
    sample_data_1.select_pca_components(explained_variance_threshold, show=False)
    ...
    visual_instance_1 = MSIVisualizer(file_path=sample_data_1.file_path, data=sample_data_1.data)
    visual_instance_1.plot_cluster_comparison(comparison_labels_1, show=False, save=True)
    # Find the optimal number of clusters using the elbow method
    sample_data_1.plot_elbow_curve(max_k=maximum_clusters, random_state=random_state, show=False)
    ...
    # To visualize spatial cluster comparison
    visual_instance_2 = MSIVisualizer(file_path=sample_data_2.file_path, data=sample_data_2.data)
    visual_instance_2.plot_cluster_comparison(comparison_labels_2, show=False, save=True)
    # Find the optimal number of clusters using the elbow method
    sample_data_2.plot_elbow_curve(max_k=maximum_clusters, random_state=random_state, show=False)
    # Evaluate candidate K-means cluster counts using clustering quality metrics
